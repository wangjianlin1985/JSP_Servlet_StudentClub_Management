...
%>
<div class="panel panel-heading" style="padding-left:40px;border-bottom-color:rgba(92,184,92,0.8);border-bottom-width:3px"><h4><b><i class="fa fa-send"></i>&nbsp对外发布（设置<%=commdao.queryCommuByOrg(Integer.parseInt(request.getParameter("org_id"))).getOrg_name()%>的详细信息）</b></h4></div>
                ...
                <form id="uploadimg"
                    ...
                    <div class="form-group">
                        ...
                        <input id="img-file" accept="image/*" type="file" name="uploadimg" class="btn btn-default form-control">
                            ...
                            <input type="button" value="上传" onclick="submit_img()" class="btn btn-default form-control">
